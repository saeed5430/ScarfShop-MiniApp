...
export const BaleUserList: React.FC = () => {
  const { tableProps } = useTable();
  const [selectedCustomer, setSelectedCustomer] = useState<BaleCustomer | null>(null);
  const [modalOpen, setModalOpen] = useState(false);

  const handleViewDetails = (record: BaleCustomer) => {
